"""AWEC Desktop v12 — liquid-glass command center and full resource archive explorer."""
...
class AWECMainWindow(V11MainWindow):
    ...
    def _build_archive_page(self):
        ...
        self.archive_tree = QTreeWidget(); self.archive_tree.setHeaderLabels(["Downloaded site / resource"]); self.archive_tree.itemDoubleClicked.connect(self._preview_selected); split.addWidget(self.archive_tree)
    ...
    def _save_v12_settings(self):
        self._v12 = {
            "tmpcrawl_dir": self.v12_tmp.text(), "max_local_storage_mb": self.v12_limit.value(),
            "min_free_space_mb": self.v12_reserve.value(), "keep_local_mirror": self.v12_keep.isChecked(),
            "purge_local_files_after_upload": self.v12_purge.isChecked(), "auto_resume": self.v12_auto.isChecked(),
            "archive_upload_live": self.v12_live.isChecked(), "archive_verify_uploads": self.v12_verify.isChecked(),
            "follow_links": self.v12_follow_links.isChecked(), "follow_external_domains": self.v12_external.isChecked(),
