...
# Public compatibility API used by desktop.engine and older AWEC adapters.
# Keep this list module-level so existing imports continue to work after the
# v11 crawler-engine rewrite.
USER_AGENT_POOL = [
