...
TRANSLATIONS = {
    'en': {
        'title': 'AWEC Desktop — High-Speed Web Archive Engine',
        'dashboard': 'Dashboard',
        'sites': 'Seed Sites',
        ...
        'storage_policy': 'Zero/Quota Storage Policy Settings',
        ...
        'ua_rotation': 'Enable Smart User-Agent Rotation Pool',
        'delay_jitter': 'Random Delay Jitter (0 to X sec)',
        'cookie_jar': 'Enable Persistent Cookie Jar Sessions',
        'verify_ssl': 'Verify SSL Certificates',
        'auto_headers': 'Auto-Generate Browser Sec-Fetch & Accept Headers',
        'max_local_mb': 'Max Local Disk Cache (MB, 0 = Keep Nothing Locally)',
        'purge_after_upload': 'Purge Files Immediately After S3 Upload',
        ...
        'lang_editor': 'Visual Interactive Language Pack Editor',
        'filter_keys': 'Search UI Keys...',
        'key_name': 'UI Label Key',
        'key_value': 'Translated Value',
        'save_key_change': 'Save Key Value',
    ...
    'hy': {
        'title': 'AWEC Desktop — Գերարագ Վեբ Արխիվացման Համակարգ',
        ...
        'network_settings': 'Գերհզոր Անտիբլոկ և Ցանցային Կարգավորումներ',
        'storage_policy': 'Սկավառակի Զրոյական/Սահմանափակ Պահպանման Կարգավորումներ',
        ...
        'ua_rotation': 'Միացնել User-Agent-ների Ավտոմատ Պտույտ',
        'delay_jitter': 'Պատահական Դադարի Տատանում (0-ից X վրկ.)',
        'cookie_jar': 'Պահպանել Cookie-ների Սեսիաները',
        'verify_ssl': 'Ստուգել SSL Սերտիֆիկատները',
        'auto_headers': 'Գեներացնել Դիտարկչի Sec-Fetch և Accept Header-ներ',
        'max_local_mb': 'Տեղային Սկավառակի Սահմանաչափ (MB, 0 = Ոչինչ չպահել համակարգչում)',
        'purge_after_upload': 'S3 Վերբեռնումից Հետո Անմիջապես Ջնջել Տեղային Ֆայլերը',
        ...
        'lang_editor': 'Վիզուալ Ինտերակտիվ Լեզվային Խմբագրիչ (Սեղմեք ցանկացած կոճակի անուն փոխելու համար)',
        'filter_keys': 'Փնտրել կոճակ կամ label...',
        'key_name': 'Կոճակի / UI Բանալի',
        'key_value': 'Թարգմանված Անվանում',
        'save_key_change': 'Պահպանել Փոփոխությունը',
    ...
    'ru': {
        'title': 'AWEC Desktop — Высокоскоростная система веб-архивирования',
        ...
        'network_settings': 'Мощные Сетевые Настройки и Антиблокировка',
        'storage_policy': 'Настройки Нулевого/Ограниченного Локального Хранилища',
        ...
        'ua_rotation': 'Включить авто-ротацию User-Agent',
        'delay_jitter': 'Случайное колебание задержки (0..X сек)',
        'cookie_jar': 'Сохранять сессии Cookie',
        'verify_ssl': 'Проверять SSL сертификаты',
        'auto_headers': 'Генерировать браузерные заголовки Sec-Fetch & Accept',
        'max_local_mb': 'Лимит диск. кэша (МБ, 0 = ничего не хранить на ПК)',
        'purge_after_upload': 'Удалять файлы сразу после загрузки в S3',
        ...
        'lang_editor': 'Визуальный Интерактивный Редактор Кнопок и Названий',
        'filter_keys': 'Поиск кнопок...',
        'key_name': 'Ключ элемента UI',
        'key_value': 'Переведенное значение',
        'save_key_change': 'Сохранить изменение',
